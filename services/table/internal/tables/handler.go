...
func (h *Handler) CreateTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Create(ctx, table); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not create table")
		return
	}

	h.publishTableStatusChanged(ctx, table, "", "table.created")

	links := apt.RESTfulLinksFor(table)
	w.WriteHeader(http.StatusCreated)
	apt.RespondSuccess(w, table, links...)
}
...
func (h *Handler) GetTable(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusNotFound, "Table not found")
		return
	}
...
func (h *Handler) ListTables(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not retrieve tables")
		return
	}

	apt.RespondCollection(w, tables, "table")
}
...
func (h *Handler) UpdateTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Save(ctx, table); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not update table")
		return
	}
...
func (h *Handler) DeleteTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Delete(ctx, id); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not delete table")
		return
	}
...
func (h *Handler) OpenTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Save(ctx, table); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not open table")
		return
	}
...
func (h *Handler) CloseTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Save(ctx, table); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not close table")
		return
	}
...
func (h *Handler) ReleaseTable(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.tableRepo.Save(ctx, table); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not release table")
		return
	}
...
func (h *Handler) CreateGroup(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.groupRepo.Create(ctx, group); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not create group")
		return
	}
...
func (h *Handler) ListGroups(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusBadRequest, "Invalid table ID")
		return
	}
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not retrieve groups")
		return
	}

	apt.RespondCollection(w, groups, "group")
}
...
func (h *Handler) DeleteGroup(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.groupRepo.Delete(ctx, id); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not delete group")
		return
	}
...
func (h *Handler) CreateReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.reservationRepo.Create(ctx, reservation); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not create reservation")
		return
	}

	links := apt.RESTfulLinksFor(reservation)
	w.WriteHeader(http.StatusCreated)
	apt.RespondSuccess(w, reservation, links...)
}
...
func (h *Handler) GetReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusNotFound, "Reservation not found")
		return
	}
...
func (h *Handler) ListReservations(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not retrieve reservations")
		return
	}

	apt.RespondCollection(w, reservations, "reservation")
}
...
func (h *Handler) UpdateReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.reservationRepo.Save(ctx, reservation); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not update reservation")
		return
	}
...
func (h *Handler) DeleteReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.reservationRepo.Delete(ctx, id); err != nil {
		...
		apt.RespondError(w, http.StatusInternalServerError, "Could not delete reservation")
		return
	}
...
func (h *Handler) decodeTableCreatePayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (TableCreateRequest, bool) {
...
func (h *Handler) decodeTableUpdatePayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (TableUpdateRequest, bool) {
	r.Body = http.MaxBytesReader(w, r.Body, MaxBodyBytes)
	defer r.Body.Close()
...
func (h *Handler) decodeTableOpenPayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (TableOpenRequest, bool) {
	r.Body = http.MaxBytesReader(w, r.Body, MaxBodyBytes)
	defer r.Body.Close()
...
func (h *Handler) decodeGroupCreatePayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (GroupCreateRequest, bool) {
	r.Body = http.MaxBytesReader(w, r.Body, MaxBodyBytes)
	defer r.Body.Close()
...
func (h *Handler) decodeReservationCreatePayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (ReservationCreateRequest, bool) {
	r.Body = http.MaxBytesReader(w, r.Body, MaxBodyBytes)
	defer r.Body.Close()
...
func (h *Handler) decodeReservationUpdatePayload(w http.ResponseWriter, r *http.Request, log apt.Logger) (ReservationUpdateRequest, bool) {
	r.Body = http.MaxBytesReader(w, r.Body, MaxBodyBytes)
	defer r.Body.Close()
