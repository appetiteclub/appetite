...
### Operations Sign In
![Operations Sign In](../img/gallery/operations-signin.png)
...
### Orders Board
![Orders Board](../img/gallery/orders-board.png)
...
![Admin Sign In - Dark Mode](../img/gallery/admin-signin-dark-mode.png)
